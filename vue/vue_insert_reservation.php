...
<body>
    ...
    <form method="post">
        ...
        <?php if (isset($_GET['idprestataire'])): ?>
    <label style="display: none;" for="idprestataire">Prestataire associé :</label>
    <select style="display: none;" name="idprestataire" id="idprestataire" required>
