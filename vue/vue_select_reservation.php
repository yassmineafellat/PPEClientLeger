        ...
        <tbody>
            <?php foreach ($lesreservations as $uneReservation): ?>
                <tr>
                    ...
                    <td><?php echo $uneReservation['idprestation']; ?></td>
...
<table>
    ...
    <tbody>
    <?php foreach ($lesreservations as $uneReservation): ?>
    <?php if ($uneReservation['idprestataire'] == $_SESSION['iduser']): ?>
        <tr>
            <td><?php echo $uneReservation['idreservation']; ?></td>
            <td><?php echo $uneReservation['idclient']; ?></td>
            <td><?php echo $uneReservation['idprestataire']; ?></td>
    ...
    <body>
        ...
        <div class="profile-card">
            ...
            <div class="profile-image">
                ...
                <img src="images/profilvide.jpg" alt="Photo de profil" height ="120">
            </div>
                ...
                <?php if ($uneReservation['idclient'] == $_SESSION['iduser']): ?>
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <button class="btn-contact" onclick="toggleMessage(this)">Contacter</button>
                            <div class="message" style="display: none;"><?php echo $uneReservation['numero_telephone']; ?></div>
                        </div>
                        <br>
                    </div>
                <?php endif; ?>
