...
<?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin' ): ?>
    ...
    <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'user' && $_SESSION['statut'] == 'prestataire'): ?>
    ...
    <table  border="1">
        ...
        <?php foreach ($lesPrestataires as $unPrestataire) : ?>
            <?php if ($unPrestataire['idprestataire'] == $_SESSION['iduser']) : ?>
...
<?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'user' && $_SESSION['statut'] == 'client'): ?>
    ...
    <form method="post">
    Filtrer par : 
    <input type="text" name="filtre1" placeholder="Zone">
    <input type="text" name="filtre2" placeholder="Service">
    ...
    <div class="card-container">
        <?php if (isset($lesPrestataires)) : ?>
            <?php foreach ($lesPrestataires as $unPrestataire) : ?>
                ...
                <img class="card-image" src="uploads\<?= $unPrestataire['image_prestataire'] ?>" height="100">
                       ...
                       <p class="price"> <?= $unPrestataire['tarifs'] ?> /Heure</p>
