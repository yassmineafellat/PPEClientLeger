...
<body>
<?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'user' && $_SESSION['statut'] !== 'client'): ?>
    <table>
        <thead>
            <tr>
...
<?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'user' && $_SESSION['statut'] == 'client'): ?>
            ...
            <div class="profile-image">
                ...
                $lesprestataires = $unControleur->selectAllPrestataires();
                    foreach ($lesprestataires as $unprestataire) {
                        if ($unprestataire['idprestataire'] == $_SESSION['idprestataire']) {
                            echo "<img src='uploads/" . $unprestataire['nom_image'] . "' alt='Image du service'>";
                        }
                    }
    ...
    if ($_SESSION['idprestataire']) {
        ...
        <h1 style="color:#007bff;">Mes réservations </h1>
        <br>
        <br>
        <br>
...
<div class="reservation-wrapper">
    <?php 
            ...
            $lesreservations = $unControleur->selectReservationbyPrestataire($idprestataire);
 ...
 if (empty($lesreservations)) {
        ...
        <div class="reservation-container">
            ...
            foreach ($lesreservations as $uneReservation): ?>
                <?php if ($uneReservation['idprestataire'] == $_SESSION['idprestataire']): ?>
                    <div class="card">
                        <div class="card-content">
                            <p style="font-size: 20px;"><strong><?php 
                            $lesclients = $unControleur->selectAllClients();
                            foreach ($lesclients as $unclient) {
                                if ($unclient['idclient'] == $uneReservation['idclient']) {
                      ...
                      ?></strong></p>
                        ...
                        <div class="card-footer">
                         <?php 
                         echo '<a href="index.php?page=11&action=valid&idreservation=' . $uneReservation['idreservation'] . '">Valider</a>';

                        if ($uneReservation['etat'] == 'confirme') {
                                echo '<button class="btn-contact" onclick="toggleMessage(this)">Contacter</button>';
                                

                                echo '<div class="message" style="display: none;">' . $unclient['email'] . '</div>';
                            }
                        }
                    }
                            ?>
