...
<form method="post" class="form-ajout-prestataire">
    <table class="pre">
        <tr>
            ...
            <td><input type="text" name="nomprestataire" value="<?= ($lePrestataire != null) ? $lePrestataire['nom'] : '' ?>"></td>
        </tr>
        <td> Image :</td>
            <td> 
                <input type="file" name="image_prestataire">
        ...
        <tr>
            <td>Mdp :</td>
            <td><input type="text" name="mdp" value="<?= ($lePrestataire != null) ? $lePrestataire['mdp'] : '' ?>"></td>
        </tr>
        <tr>
            <td>Compétences :</td>
        ...
        <tr>
            <td>Tarifs :</td>
            <td><input type="number" name="tarifs"><?= ($lePrestataire != null) ? $lePrestataire['tarifs'] : '' ?></input></td>
        </tr>
        <tr>
            <td>Disponibilité :</td>
...
<?php
if(isset($_FILES['image_prestataire']) && $_FILES['image_prestataire']['error'] == 0) {  
    $error = 1;
    if ($_FILES['image_prestataire']['size'] <= 3000000) {
        $informationsImage = pathinfo($_FILES['image_prestataire']['name']);
        ...
        if(in_array($extensionImage, $extensionsArray)) {
            ...
            $address = 'uploads/' . $_FILES['image_prestataire']['name'];
            move_uploaded_file($_FILES['image_prestataire']['tmp_name'], $address); 
            $error = 0;
